...
public enum ErrorType implements BaseEnum {
	...
	// General Errors
	RECORD_DOES_NOT_EXIST("1000", "Record does not exist"), RECORD_NOT_FOUND("1001", "Record not found"),
	INVALID_INPUT("1002", "The provided input is invalid"), ACCESS_DENIED("1003", "Access is denied"),
	...
	INVALID_TOKEN("2001", "The provided token is invalid"), EXPIRED_TOKEN("2002", "The provided token has expired"),
